...
| Data analysis | End-to-end Python pipelines, replication verification, publication-ready output |
...
| `python-code-conventions` | `*.py` | Python coding standards + math line-length exception |
...
| Python | Figures & analysis | [python.org](https://www.python.org/) |
